...
class DiggingDeeperController extends Controller
{
    public function collections()
    {
        ...
        $result['where_first'] = $collection->firstWhere('created_at', '>' , '2020-02-24 03:46:16');
        ...
        $filtered = $collection->filter(function ($item) {
            // Додаємо захист: якщо дати немає, просто ігноруємо цей елемент
        ...
        dd('УСЕ ПРАЦЮЄ!', $result); // Тимчасовий вивід для перевірки
    }
}
